...
func Test_LTE_Evaluator(t *testing.T) {
	type args struct {
		prop string
		op   string
		val  string
	...
	tests := []struct {
		...
		args:    args{"number", "<=", "100", "Must be less than 100"},
		obj:     map[string]interface{}{},
		want:    false,
		wantErr: false,
	}, {
		...
		args:    args{"number", "<=", "100", "Must be less than 100"},
		obj:     map[string]interface{}{"number": 101},
		want:    false,
		wantErr: false,
	}, {
		name:    "Float evaluator",
		args:    args{"number", "<=", "99.9", "Must be less than 99.9"},
		...
		name:    "Float evaluator",
		args:    args{"number", "<=", "99.9", "Must be less than 99.9"},
		obj:     map[string]interface{}{"number": 100.1},
		want:    false,
		wantErr: false,
	}, {
